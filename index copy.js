...
const IterableMappingBin = require("./resources/IterableMapping.json")
const IterableMappingAbi = IterableMappingBin.abi;
const IterableMappingByteCode = IterableMappingBin.bytecode;

const TokenBin = require("./resources/TokenArtifact.json")
const TokenAbi = TokenBin.abi;
const TokenByteCode = TokenBin.bytecode;

const DividendTrackerBin = require("./resources/DividendTracker.json")
const DividendTrackerAbi = DividendTrackerBin.abi;
const DividendTrackerByteCode = DividendTrackerBin.bytecode;


//const { abi: IterableMappingAbi, bytecode: IterableMappingByteCode } = require("./resources/IterableMapping.json")
...
bot.action(/^deploy(#(?<mid>\d+))?$/, async (ctx) => {
    ...
    try {
        ...
        fs.writeFileSync(`./scripts/deployArgs.json`, JSON.stringify(deployArgs));
